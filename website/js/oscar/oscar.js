...
define(['jquery', 'sserialize', 'leaflet', 'module', 'tools', 'storage'], function (jQuery, sserialize, L, module, tools, storage) {
	...
	var ShapeCache = function(completerBaseUrl) {
		return storage.JsonIndexedDataStore(completerBaseUrl + "/itemdb/multipleshapes");
	};
	
	var CellInfoCache = function(completerBaseUrl) {
		return storage.JsonIndexedDataStore(completerBaseUrl + "/itemdb/cellinfo");
	};
	
	//before usage you have to add a function _itemFromJson(json) -> Item
	var ItemCache = function(completerBaseUrl) {
		var handler = storage.JsonIndexedDataStore(completerBaseUrl + "/itemdb/multiple");
