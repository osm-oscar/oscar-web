    ...
    return menu = {
        ...
        displayCategories: function () {
            ...
            if (c.is(":empty")) {
                ...
                $("<div class='ui-widget'><label for='tagsSearch' data-toggle='tooltip' data-placement='right' title='Search for tags not covered by the menu above'>Tagsearch: </label><input id='tagsSearch' placeholder='What tag are you looking for?'></div>").appendTo(container);
                c.append(container);
